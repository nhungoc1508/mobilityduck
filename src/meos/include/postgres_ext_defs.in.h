...
extern int interval_cmp(const MeosInterval *interv1, const MeosInterval *interv2);
extern MeosInterval *interval_in(const char *str, int32 typmod);
extern char *interval_out(const MeosInterval *interv);
extern TimeADT time_in(const char *str, int32 typmod);
extern char *time_out(TimeADT t);
extern MeosTimestamp timestamp_in(const char *str, int32 typmod);
extern char *timestamp_out(MeosTimestamp t);
